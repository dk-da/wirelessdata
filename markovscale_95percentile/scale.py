	...
	for sample2 in sampleList[sampleList.index(sample1):]:
		...
		if (sample1 == sample2):
			...
			if (sample1.owner == sample2.owner):
				line = "%d %s %s %s" % (1, sample1.owner+"."+sample1.device+"."+sample2.owner+"."+sample2.device, sample1.hashedmac, sample2.hashedmac)
				print >> outf, line
				print >> outf, GcorList
			else:
				line = "%d %s %s %s" % (0, sample1.owner+"."+sample1.device+"."+sample2.owner+"."+sample2.device, sample1.hashedmac, sample2.hashedmac)
				print >> outf, line
				print >> outf, GcorList
		print "1"
