...
argc = len(argvs)
if (argc != 3):
	print "Usage : python %s inputMatrixfile threshold" % argvs[0]
	quit()
...
groupDic = {}
clustDic = {}
groupf = open("/home/dk/wirelessdata/markov_withDiag/output/kmeans/kmeans10.txt", 'r')
...
for clust, l in clustDic.items():
	for mac in l:
		...
		if maxscore == threshold : resultDic[mac] = {"alone":0.0}
